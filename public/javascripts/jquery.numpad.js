	...
	$.fn.numpad = function ( options ) {
		...
		return this.each( function () {
			...
			if ( $( '#' + id ).length == 0 ) {
				...
				var display = $( options.displayTpl ).addClass( 'nmpd-display' ).addClass( 'form-control' );
				...
				table.append(
					$( options.rowTpl )
					.append( $( options.cellTpl ).append( $( options.buttonNumberTpl ).html( 7 ).addClass( 'numero' ).addClass( 'btn' ).addClass( 'btn-default' ) ) )
					.append( $( options.cellTpl ).append( $( options.buttonNumberTpl ).html( 8 ).addClass( 'numero' ).addClass( 'btn' ).addClass( 'btn-default' ) ) )
					.append( $( options.cellTpl ).append( $( options.buttonNumberTpl ).html( 9 ).addClass( 'numero' ).addClass( 'btn' ).addClass( 'btn-default' ) ) )
					.append( $( options.cellTpl ).append( $( options.buttonFunctionTpl ).html( options.textDelete ).addClass( 'del' ).addClass( 'btn' ).addClass( 'btn-default' ).click( function () {
						nmpd.setValue( nmpd.getValue().toString().substring( 0, nmpd.getValue().toString().length - 1 ) );
					} ) ) )
				).append(
					$( options.rowTpl )
					.append( $( options.cellTpl ).append( $( options.buttonNumberTpl ).html( 4 ).addClass( 'numero' ).addClass( 'btn' ).addClass( 'btn-default' ) ) )
					.append( $( options.cellTpl ).append( $( options.buttonNumberTpl ).html( 5 ).addClass( 'numero' ).addClass( 'btn' ).addClass( 'btn-default' ) ) )
					.append( $( options.cellTpl ).append( $( options.buttonNumberTpl ).html( 6 ).addClass( 'numero' ).addClass( 'btn' ).addClass( 'btn-default' ) ) )
					.append( $( options.cellTpl ).append( $( options.buttonFunctionTpl ).html( options.textClear ).addClass( 'clear' ).addClass( 'btn' ).addClass( 'btn-default' ).click( function () {
						nmpd.setValue( '' );
					} ) ) )
				).append(
					$( options.rowTpl )
					.append( $( options.cellTpl ).append( $( options.buttonNumberTpl ).html( 1 ).addClass( 'numero' ).addClass( 'btn' ).addClass( 'btn-default' ) ) )
					.append( $( options.cellTpl ).append( $( options.buttonNumberTpl ).html( 2 ).addClass( 'numero' ).addClass( 'btn' ).addClass( 'btn-default' ) ) )
					.append( $( options.cellTpl ).append( $( options.buttonNumberTpl ).html( 3 ).addClass( 'numero' ).addClass( 'btn' ).addClass( 'btn-default' ) ) )
					.append( $( options.cellTpl ).append( $( options.buttonFunctionTpl ).html( options.textCancel ).addClass( 'cancel' ).addClass( 'btn' ).addClass( 'btn-default' ).click( function () {
						nmpd.close( false );
					} ) ) )
				).append(
					$( options.rowTpl )
					...
					.append( $( options.cellTpl ).append( $( options.buttonNumberTpl ).html( 0 ).addClass( 'numero' ).addClass( 'btn' ).addClass( 'btn-default' ) ) )
					...
					.append( $( options.cellTpl ).append( $( options.buttonFunctionTpl ).html( options.textDone ).addClass( 'done' ).addClass( 'btn' ).addClass( 'btn-primary' ) ) )
				);
